...
//
// Registers the hosted Ace Data Cloud "minimax" MCP server with VS Code
...
//   2. VS Code SecretStorage (key "minimax.apiToken")
...
//   - acedatacloud.minimax.setApiToken
//   - acedatacloud.minimax.clearApiToken

const vscode = require("vscode");

const PROVIDER_ID = "acedatacloud.minimax";
const SERVER_LABEL = "Minimax MCP";
const SERVER_URL = "https://minimax.mcp.acedata.cloud/mcp";
const SET_TOKEN_CMD = "acedatacloud.minimax.setApiToken";
const CLEAR_TOKEN_CMD = "acedatacloud.minimax.clearApiToken";
// Per-extension SecretStorage namespace; we keep one key per service so
// rotating one API key doesn't affect siblings.
const SECRET_KEY = "minimax.apiToken";
