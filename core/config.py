"""Configuration management for MCP Minimax server."""
...
class Settings:
    ...
    default_model: str = field(
        default_factory=lambda: os.getenv("MINIMAX_DEFAULT_MODEL", "MiniMax-H3")
    )

    # Request Configuration
    request_timeout: float = field(
        default_factory=lambda: float(os.getenv("MINIMAX_REQUEST_TIMEOUT", "1800"))
    )

    # Server Configuration
    server_name: str = field(default_factory=lambda: os.getenv("MCP_SERVER_NAME", "minimax"))
